...
5. isTheWordFromL2가 true일 때, "뉘앙스" 항목은 $l2 단어 "$word"의 뉘앙스를 $l1로 간단히 설명. isTheWordFromL2가 false일 때, 번역된 단어들의 뉘앙스를 각각 설명.
6. isTheWordFromL2가 true일 때, "회화에서의_사용" 항목은 실제 회화에서 언제 어떻게 해당 $l2 단어가 사용되는지 $l1로 설명. isTheWordFromL2가 false일 때, $l2로 번역된 단어들이 어떤 상황에서 사용되는지 설명.
7. "대화_예시"는 총 최대 2세트. 하나의 세트는 $l2 대화와 번역된 $l1 대화로 구성.
8. "비슷한_표현"은 총 최대 4개. $l2 단어와 그 뜻을 $l1로 작성.
